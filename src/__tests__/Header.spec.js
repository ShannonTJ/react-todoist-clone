...
describe("<Header/>", () => {
  describe("Success", () => {
    ...
    it("renders the header component and setShowQuickAddTask to true using onClick", () => {
      const darkMode = false;
    ...
    it("renders the header component and setShowQuickAddTask to true using onKeyDown", () => {
      const darkMode = false;
    ...
    it("renders the header component and setShowQuickAddTask to true and then false using onKeyDown", () => {
      const darkMode = false;
